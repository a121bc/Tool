...
package com.ltj.tool.activiti.runtime.process;
...
public class ProcessInstanceResponse {
  ...
  protected java.util.List<RestVariable> variables = new ArrayList<>();
  ...
  public java.util.List<RestVariable> getVariables() {
    return variables;
  }
